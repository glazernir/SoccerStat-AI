...
def plot_dataset_with_continuous_coloring(data, param):
    def on_click(event):
        if event.inaxes:
            ...
            # Get the corresponding PC1, PC2, and player_id values
...
# def head_to_head_comparison(weightedData,playersData, player1_id, player2_id):
#     print(weightedData.head())
#     player1_data = weightedData[weightedData['player_id'] == player1_id].iloc[0]
#     player2_data = weightedData[weightedData['player_id'] == player2_id].iloc[0]
#     columns_to_compare = weightedData.columns.drop('player_id')
#     table = PrettyTable()
#     table.field_names = ["Statistic", f"Player {player1_id}", f"Player {player2_id}"]
#     for column in columns_to_compare:
#         table.add_row([column, player1_data[column], player2_data[column]])
#     print(table)
